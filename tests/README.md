...
- **`conftest.py`** — Legge `testdata/workflow.yaml` con **PyYAML + `WorkflowYamlSchema`** (infrastructure boundary), poi converte in DTO core con `to_core()` e valida la topologia.
